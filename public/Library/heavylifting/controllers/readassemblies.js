...
if (!entry) {
  ...
  query1.exec(function (err, results) {
    ...
    res.render(directory+'/views/formassemblies', {
      title: 'Form',
      formdata : JSON.stringify(formdata),
      idItem : JSON.stringify(idItem),
      parentid : JSON.stringify(parentid),
...
exports.jstree = function(req, res) {
  ...
  var query1 = assembliesModel.find(
  {
    "active": "true" ,
    "parentid": ids,      
  })
...
/////////////////////////////////////
var query3 = assembliesModel.find(
{
  $and : 
  [
  {
...
query1.exec(function (err, parentItem) {
  if(err){console.log('Error Here Query 1 - formsModel'); return;}
...
formsModel.find().limit(3).exec(function (err, forms) {
  if(err){console.log('Error Here Query 2 - formsModel'); return;}
...
////       DEPLOY THE REQUESTED TEMPLATE         //// 
////////////////////////////////////////////////////
exports.assemblyload = function(req, res) {
//Debugging  
debugging(req,debugMode)
//Which id data to use.
var ids = req.query['ids']
...
////////////////////////////
//Query to find the menu item selected.
var query = assembliesModel.findOne(
{
$and : 
[
{$or: [
...
// 3.RETURN THE ASSOCIATED FORM ELMENTS OF THE ABOVE CHILD ITEM  //
//////////////////////////////////////////////////////////////////
var query2 = assembliesModel.find(
{
$and : 
[
{
...
//  5.LEGACY ITEM FOR PRIMER FORMS  //
/////////////////////////////////////
var query4 = assembliesModel.find(
{
'entry.parent' : childitem,
'active' : 'true'
})
...
//  6.THE TEMPLATE TO LOAD  //
//////////////////////////////
var query5 = assembliesModel.findOne(
{
$and : 
[
{$or: [
